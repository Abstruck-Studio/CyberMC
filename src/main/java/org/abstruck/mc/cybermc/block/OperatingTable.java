 ...
 * @author Astrack
 */
public class OperatingTable extends Block {
    public OperatingTable() {
        super(Properties.of(Material.STONE).harvestLevel(2));
    }
    ...
    @Override
    public @NotNull ActionResultType use(@NotNull BlockState blockState, World world, @NotNull BlockPos blockPos, @NotNull PlayerEntity player, @NotNull Hand hand, @NotNull BlockRayTraceResult blockRayTraceResult) {
        //判断是否是客户端玩家使用主手互动
