...
import org.abstruck.mc.cybermc.block.OperatingTable;
...
public class BlockInit {
    ...
    public static final RegistryObject<Block> OPERATING_TABLE = REGISTER.register("operating_table", OperatingTable::new);
}
